...
//포스팅 수정 값 저장
router.post("/postingLists/:postNumber/editSave", async(req, res) => {
  const postNumber = req.params.postNumber;
  console.log(postNumber)
  let { name, title, content } = req.body;
  console.log(name, title, content)
  await Writing.updateOne({ "postNumber" : postNumber },{ $set: req.body})
...
//포스팅 입력값 저장
router.post("/postingFormSave", async(req, res) => {
